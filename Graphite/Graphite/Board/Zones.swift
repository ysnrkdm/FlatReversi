...
public class Zones {
    ...
    public func getTopNByRandomInPuttables(_ n: Int, puttables: [(Int, Int)]) -> [(Int, Int)] {
...
public class ZonesFactory {
    public class func createZoneUniform(_ uniformVal: Double) -> Zones {
    ...
    public class func createZoneTypical4(_ aVal: Double, bVal: Double, cVal: Double, dVal: Double) -> Zones {
    ...
    public class func createZoneTypical7(_ aVal: Double, bVal: Double, cVal: Double, dVal: Double, eVal: Double, fVal: Double, gVal: Double) -> Zones{
        let zones: [[Double]] = [
    ...
    public class func createZoneTypical8(_ aVal: Double, bVal: Double, cVal: Double, dVal: Double, eVal: Double, fVal: Double, gVal: Double, hVal: Double) -> Zones{
        let zones: [[Double]] = [

...
public class SimpleBitBoard: FastBitBoard {
    ...
    override public func getUnsafeBitBoard() -> BitBoard {
        return bb
    }

    override public func height() -> Int {
        return _height
    }
    override public func width() -> Int {
        return _width
    }

    override public func initialize(_ width: Int, height: Int) {
        // ignors width and height
    }

    override public func withinBoard(_ x: Int, y: Int) -> Bool {
        return (0 <= x && x < width() && 0 <= y && y < height())
    }

    override public func set(_ color: Pieces, x: Int, y: Int) {
        bb.set(color, x: x, y: y)
    }

    override public func get(_ x: Int, y: Int) -> Pieces {
        return bb.get(x, y: y)
    }
    ...
    override public func updateGuides(_ color: Pieces) -> Int {
    ...
    override public func put(_ color: Pieces, x: Int, y: Int, guides: Bool, returnChanges: Bool) -> [(Int, Int)] {
        if !withinBoard(x, y: y) {
            return []
        }
    ...
    override public func isPieceAt(_ piece: Pieces, x: Int, y: Int) -> Bool {
        return bb.isPieceAt(piece, x: x, y: y)
    }

    // MARK: Query functoverride ions
    override public func getNumBlack() -> Int {
        return bb.getNumBlack()
    }

    override public func getNumWhite() -> Int {
        return bb.getNumWhite()
    }

    override public func canPut(_ color: Pieces, x: Int, y: Int) -> Bool {
        return bb.canPut(color, x: x, y: y)
    }

    override public func getPuttables(_ color: Pieces) -> [(Int, Int)] {
        return listFromBitBoard(bb.getPuttables(color))
    }

    override public func isAnyPuttable(_ color: Pieces) -> Bool {
    ...
    override public func getReversible(_ color: Pieces, x: Int, y: Int) -> [(Int, Int)] {
        return listFromBitBoard(bb.getReversible(color, x: x, y: y))
    }

    override public func isEmpty(_ x: Int, y: Int) -> Bool {
        return bb.isEmpty(x, y: y)
    }

    override public func numPeripherals(_ color: Pieces, x: Int, y: Int) -> Int {
    ...
    override public func hashValue() -> Int {
        return bb.hashValue
    }
    ...
    override public func clone() -> Board {
        let bb = self.bb

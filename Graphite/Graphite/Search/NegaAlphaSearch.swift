...
public class NegaAlphaSearch : Search {
    var nodeCount = 0
    ...
    public func search(_ boardRepresentation: BoardRepresentation, forPlayer: Pieces, evaluator: Evaluator, depth: Int) -> SearchResult {
        nodeCount = 0

...
for i in range(0,5):
    ...
    proc_a = subprocess.Popen('/Users/yoshinori/Documents/OneDrive/projects/othello/edax/4.3.2/bin/mEdax -q', shell=True, stdin=subprocess.PIPE, stdout=subprocess.PIPE)
